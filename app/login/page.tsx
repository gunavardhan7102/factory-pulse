    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-12 text-white">
        <div>
          ...
          <p className="text-xl text-slate-300 font-light">Predictive Maintenance Platform</p>
          <p className="text-slate-400 mt-4 leading-relaxed max-w-md">
            Intelligent maintenance management platform for manufacturing equipment. Real-time monitoring, predictive analytics, and automated work order management.
          </p>
        </div>
